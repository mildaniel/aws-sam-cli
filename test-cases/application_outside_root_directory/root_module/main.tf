...
resource "aws_apigatewayv2_api" "quick_create_api" {
  ...
  protocol_type  = "HTTP"
  target         = aws_lambda_function.function1.invoke_arn
  route_key      = "GET /hello"
}

resource "aws_apigatewayv2_api" "quick_create_api2" {
  name           = "quick_create_api2"
  protocol_type  = "HTTP"
  target         = module.function2.invoke_arn
  route_key      = "GET /function2/hello"
}

resource "aws_apigatewayv2_api" "quick_create_api7" {
  name           = "quick_create_api7"
  protocol_type  = "HTTP"
  target         = module.function7.lambda_function_invoke_arn
  route_key      = "GET /function7/hello"
}